...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Good.go_online_time'
        db.add_column('home_good', 'go_online_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 27, 15, 6, 51, 896000)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Good.go_online_time'
        db.delete_column('home_good', 'go_online_time')
