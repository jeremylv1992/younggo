...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Good'
        db.create_table('home_good', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='goods', to=orm['home.Store'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('options', self.gf('django.db.models.fields.TextField')()),
            ('prices', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('home', ['Good'])


    def backwards(self, orm):
        
        # Deleting model 'Good'
        db.delete_table('home_good')
