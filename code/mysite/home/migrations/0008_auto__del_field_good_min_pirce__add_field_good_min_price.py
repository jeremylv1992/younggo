...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Good.min_pirce'
        db.delete_column('home_good', 'min_pirce')

        # Adding field 'Good.min_price'
        db.add_column('home_good', 'min_price', self.gf('django.db.models.fields.FloatField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Good.min_pirce'
        db.add_column('home_good', 'min_pirce', self.gf('django.db.models.fields.FloatField')(default=10), keep_default=False)

        # Deleting field 'Good.min_price'
        db.delete_column('home_good', 'min_price')
