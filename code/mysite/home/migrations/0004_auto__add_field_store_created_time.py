...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Store.created_time'
        db.add_column('home_store', 'created_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 26, 20, 51, 37, 965000)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Store.created_time'
        db.delete_column('home_store', 'created_time')
