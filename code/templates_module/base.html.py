...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\t</head>\r\n\t\r\n\t<body>\r\n\t\t')
        # SOURCE LINE 30
        runtime._include_file(context, u'frontend_templates.part', _template_uri)
        __M_writer(u'\r\n    \t<!--\u9876\u90e8\u5bfc\u822a Start-->\r\n\t\t')
...
def render_head_js(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 20
        __M_writer(unicode(STATIC_URL))
        __M_writer(u'js/jquery.json-2.3.min.js"></script>\r\n\t        <!-- External library --->\r\n\t\t\t<script src="')
        # SOURCE LINE 22
        __M_writer(unicode(STATIC_URL))
        __M_writer(u'js/mustache.min.js" type="text/javascript" charset="utf-8"></script>\t        \r\n\t\t\t<!-- base js -->\r\n\t\t\t<script src="')
        # SOURCE LINE 24
        __M_writer(unicode(STATIC_URL))
        __M_writer(u'js/header.js" type="text/javascript" charset="utf-8"></script>\r\n\t\t\t')
        return ''
    finally:
        context.caller_stack._pop_frame()
